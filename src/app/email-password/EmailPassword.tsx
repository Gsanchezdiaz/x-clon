...
export default function EmailPassword({ user }: EmailPasswordProps) {
  ...
  return (
    <AuthPage
      ...
      intro="Sign in or sign up using your email and password."
      steps={[
      ...
      {!currentUser && (
        <>
          ...
          >
            ...
            />
            <div
              className="pointer-events-none absolute -bottom-10 right-2 -z-10 h-28 w-40 rounded-full g-[linear-gradient(140deg,rgba(45,212,191,0.32),rgba(59,130,246,0.12))] blur-xl"
              aria-hidden="true"
            />
